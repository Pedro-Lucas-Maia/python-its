    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-neutral-50 dark:bg-neutral-950 font-sans text-neutral-900 dark:text-neutral-100 p-4 relative">
      ...
      <div className="w-full max-w-md bg-white dark:bg-neutral-900 p-8 sm:p-10 rounded-2xl shadow-[0_4px_24px_rgba(0,0,0,0.04)] dark:shadow-[0_4px_24px_rgba(0,0,0,0.2)] border border-neutral-100 dark:border-neutral-800 transition-all">
        <div className="text-center mb-8">
          ...
          <div className="text-neutral-500 dark:text-neutral-400 text-sm">Bem-vindo de volta</div>
        </div>
        ...
        {resolvedSearchParams?.message && (
          <div className="bg-emerald-50 dark:bg-emerald-950/50 text-emerald-700 dark:text-emerald-400 px-4 py-3 rounded-lg text-sm mb-6 border border-emerald-100 dark:border-emerald-900/50">
            {resolvedSearchParams.message}
          </div>
        )}
        ...
        <div className="mt-8 text-center text-sm text-neutral-500 dark:text-neutral-400">
          Não tem uma conta?{" "}
          <Link href="/register" className="text-neutral-900 dark:text-neutral-100 font-medium hover:opacity-70 transition-opacity">
            Cadastre-se
          </Link>
        </div>
      </div>
